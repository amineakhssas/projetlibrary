      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              margin: const EdgeInsets.fromLTRB(11, 0, 21.4, 23),
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Container(
                      margin: const EdgeInsets.fromLTRB(0, 2.5, 0, 49.5),
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
            ...
            Container(
              margin: const EdgeInsets.fromLTRB(19, 0, 19, 34),
              child: Align(
                alignment: Alignment.topLeft,
                child: Container(
                  decoration: BoxDecoration(
            ...
            Container(
              margin: const EdgeInsets.fromLTRB(20, 0, 20, 10.5),
              child: Align(
                alignment: Alignment.topLeft,
                child: Text(
                  'About the book',
            ...
            Container(
              margin: const EdgeInsets.fromLTRB(20, 0, 20, 24.5),
              child: Align(
                alignment: Alignment.topLeft,
                child: Text(
