      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              margin: const EdgeInsets.fromLTRB(11, 0, 32.5, 48),
              child: Row(
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            margin: const EdgeInsets.fromLTRB(0, 0, 14.4, 9.5),
                            child: Text(
                          ...
                          Container(
                            child: Text(
                              'Its a play on the Horror trope that Black people always die first and if they dont die first you know they wont make it to the end of the movie. ',
                              style: GoogleFonts.getFont(
                                'Inter',
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  height: 24,
                                  child: SvgPicture.asset(
                                    'assets/vectors/user_142_x2.svg',
                                  ),
                                ),
                              ],
                            ),
                            ...
                            child: Opacity(
                              ...
                              child: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  height: 24,
                                  child: SvgPicture.asset(
                                    'assets/vectors/search_122_x2.svg',
                                  ),
                                ),
                              ),
                            ),
