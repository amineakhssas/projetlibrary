      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              margin: const EdgeInsets.fromLTRB(11, 0, 27.2, 32.5),
              child: Row(
                ...
                children: [
                  Expanded(
                    child: Container(
                      margin: const EdgeInsets.fromLTRB(0, 0, 14, 17.5),
                      child: Container(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '"Hell Put to Shame is a powerfully unsettling portrait of the single most savage episode in the long decades of savagery inflicted by white southerners on their Black neighbors in the 20th century—and the methodical process that followed to erase those crimes from Americas collective memory.',
                            style: GoogleFonts.getFont(
                              'Inter',
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  margin:
                                      const EdgeInsets.fromLTRB(0, 0, 0, 2.5),
                                  child: Align(
                                    alignment: Alignment.topLeft,
                                    child: Text(
                                      'Author',
            ...
            Container(
              margin: const EdgeInsets.fromLTRB(20, 0, 20, 7.5),
              child: Align(
                alignment: Alignment.topLeft,
                child: Text(
                  'About the book',
            ...
            Container(
              margin: const EdgeInsets.fromLTRB(21, 0, 30.2, 20.5),
              child: Text(
                '"Hell Put to Shame" is a poignant tale of resilience in the face of adversity. It follows the journey of a protagonist who confronts lifes hardships with unwavering determination, ultimately triumphing over seemingly insurmountable obstacles. Through courage, perseverance, and a steadfast belief in oneself, the protagonist emerges victorious, proving that even in the darkest of times, there is always hope for redemption and transformation.',
                style: GoogleFonts.getFont(
                  'Inter',
                  fontWeight: FontWeight.w400,
                  fontSize: 12,
                            ...
                            child: Opacity(
                              ...
                              child: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  height: 24,
                                  child: SvgPicture.asset(
                                    'assets/vectors/search_115_x2.svg',
                                  ),
                                ),
                              ),
                            ),
